# Xsolla Login UE4 Plugin

Xsolla Login UE4 Plugin is used to integrate [Xsolla Login API](https://developers.xsolla.com/api/v2/login/) methods with apps based on the [Unreal Engine](https://www.unrealengine.com/). Main features:
